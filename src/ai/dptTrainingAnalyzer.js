// src/ai/dptTrainingAnalyzer.js

/*
  =========================================================
  DPT Training Analyzer
...
/*
  ...
  previousAnalysis 可傳入上一輪 analyzeDptTraining 的結果。
  若沒有傳入，仍會依本輪結果直接判定。
*/
...
export function analyzeDptTraining({
  records = [],
  ...
  /*
    可選：傳入上一輪 analyzeDptTraining 的結果，
    用於防止單輪偶然表現造成難度反覆跳動。
  */
...
export default analyzeDptTraining;