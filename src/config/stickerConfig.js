...
export const COMMON_STICKERS = Object.freeze({
  common_leaf: {
    ...
    image: `${STICKER_ASSET_BASE}/common/leaf.webp`,
    thumbnail: `${STICKER_ASSET_BASE}/common/leaf.webp`,
  ...
  common_acorn: {
    ...
    type: STICKER_TYPES.COMMON,
    rarity: STICKER_TYPES.COMMON,
    image: `${STICKER_ASSET_BASE}/common/acorn.webp`,
    thumbnail: `${STICKER_ASSET_BASE}/common/acorn.webp`,
    obtainableFromHatGame: true,
    repeatable: true,
    fusionEnabled: true,
  ...
  common_mushroom: {
    ...
    type: STICKER_TYPES.COMMON,
    rarity: STICKER_TYPES.COMMON,
    image: `${STICKER_ASSET_BASE}/common/mushroom.webp`,
    thumbnail: `${STICKER_ASSET_BASE}/common/mushroom.webp`,
    obtainableFromHatGame: true,
    repeatable: true,
    fusionEnabled: true,
  ...
  common_flower: {
    ...
    type: STICKER_TYPES.COMMON,
    rarity: STICKER_TYPES.COMMON,
    image: `${STICKER_ASSET_BASE}/common/flower.webp`,
    thumbnail: `${STICKER_ASSET_BASE}/common/flower.webp`,
    obtainableFromHatGame: true,
    repeatable: true,
    fusionEnabled: true,
  ...
  common_butterfly: {
    ...
    type: STICKER_TYPES.COMMON,
    rarity: STICKER_TYPES.COMMON,
    image: `${STICKER_ASSET_BASE}/common/butterfly.webp`,
    thumbnail: `${STICKER_ASSET_BASE}/common/butterfly.webp`,
    obtainableFromHatGame: true,
    repeatable: true,
    fusionEnabled: true,
  ...
  common_bee: {
    ...
    type: STICKER_TYPES.COMMON,
    rarity: STICKER_TYPES.COMMON,
    image: `${STICKER_ASSET_BASE}/common/bee.webp`,
    thumbnail: `${STICKER_ASSET_BASE}/common/bee.webp`,
    obtainableFromHatGame: true,
    repeatable: true,
    fusionEnabled: true,
  ...
  common_apple: {
    ...
    type: STICKER_TYPES.COMMON,
    rarity: STICKER_TYPES.COMMON,
    image: `${STICKER_ASSET_BASE}/common/apple.webp`,
    thumbnail: `${STICKER_ASSET_BASE}/common/apple.webp`,
    obtainableFromHatGame: true,
    repeatable: true,
    fusionEnabled: true,
  ...
  common_berry: {
    ...
    type: STICKER_TYPES.COMMON,
    rarity: STICKER_TYPES.COMMON,
    image: `${STICKER_ASSET_BASE}/common/berry.webp`,
    thumbnail: `${STICKER_ASSET_BASE}/common/berry.webp`,
    obtainableFromHatGame: true,
    repeatable: true,
    fusionEnabled: true,
  ...
  common_cloud: {
    ...
    type: STICKER_TYPES.COMMON,
    rarity: STICKER_TYPES.COMMON,
    image: `${STICKER_ASSET_BASE}/common/cloud.webp`,
    thumbnail: `${STICKER_ASSET_BASE}/common/cloud.webp`,
    obtainableFromHatGame: true,
    repeatable: true,
    fusionEnabled: true,
  ...
  common_moon: {
    ...
    type: STICKER_TYPES.COMMON,
    rarity: STICKER_TYPES.COMMON,
    image: `${STICKER_ASSET_BASE}/common/moon.webp`,
    thumbnail: `${STICKER_ASSET_BASE}/common/moon.webp`,
    obtainableFromHatGame: true,
    repeatable: true,
    fusionEnabled: true,
  ...
  common_star: {
    ...
    type: STICKER_TYPES.COMMON,
    rarity: STICKER_TYPES.COMMON,
    image: `${STICKER_ASSET_BASE}/common/star.webp`,
    thumbnail: `${STICKER_ASSET_BASE}/common/star.webp`,
    obtainableFromHatGame: true,
    repeatable: true,
    fusionEnabled: true,
  ...
  common_rainbow: {
    ...
    type: STICKER_TYPES.COMMON,
    rarity: STICKER_TYPES.COMMON,
    image: `${STICKER_ASSET_BASE}/common/rainbow.webp`,
    thumbnail: `${STICKER_ASSET_BASE}/common/rainbow.webp`,
    obtainableFromHatGame: true,
    repeatable: true,
    fusionEnabled: true,
...
export const RARE_STICKERS = Object.freeze({
  rare_golden_leaf: {
    ...
    image: `${STICKER_ASSET_BASE}/rare/golden_leaf.webp`,
    thumbnail: `${STICKER_ASSET_BASE}/rare/golden_leaf.webp`,
  ...
  rare_golden_acorn: {
    ...
    type: STICKER_TYPES.RARE,
    rarity: STICKER_TYPES.RARE,
    image: `${STICKER_ASSET_BASE}/rare/golden_acorn.webp`,
    thumbnail: `${STICKER_ASSET_BASE}/rare/golden_acorn.webp`,
    obtainableFromHatGame: false,
    repeatable: true,
    fusionEnabled: true,
  ...
  rare_magic_mushroom: {
    ...
    type: STICKER_TYPES.RARE,
    rarity: STICKER_TYPES.RARE,
    image: `${STICKER_ASSET_BASE}/rare/magic_mushroom.webp`,
    thumbnail: `${STICKER_ASSET_BASE}/rare/magic_mushroom.webp`,
    obtainableFromHatGame: false,
    repeatable: true,
    fusionEnabled: true,
  ...
  rare_rainbow_flower: {
    ...
    type: STICKER_TYPES.RARE,
    rarity: STICKER_TYPES.RARE,
    image: `${STICKER_ASSET_BASE}/rare/rainbow_flower.webp`,
    thumbnail: `${STICKER_ASSET_BASE}/rare/rainbow_flower.webp`,
    obtainableFromHatGame: false,
    repeatable: true,
    fusionEnabled: true,
  ...
  rare_shining_butterfly: {
    ...
    type: STICKER_TYPES.RARE,
    rarity: STICKER_TYPES.RARE,
    image: `${STICKER_ASSET_BASE}/rare/shining_butterfly.webp`,
    thumbnail: `${STICKER_ASSET_BASE}/rare/shining_butterfly.webp`,
    obtainableFromHatGame: false,
    repeatable: true,
    fusionEnabled: true,
  ...
  rare_honey_bee: {
    ...
    type: STICKER_TYPES.RARE,
    rarity: STICKER_TYPES.RARE,
    image: `${STICKER_ASSET_BASE}/rare/honey_bee.webp`,
    thumbnail: `${STICKER_ASSET_BASE}/rare/honey_bee.webp`,
    obtainableFromHatGame: false,
    repeatable: true,
    fusionEnabled: true,
  ...
  rare_crystal_apple: {
    ...
    type: STICKER_TYPES.RARE,
    rarity: STICKER_TYPES.RARE,
    image: `${STICKER_ASSET_BASE}/rare/crystal_apple.webp`,
    thumbnail: `${STICKER_ASSET_BASE}/rare/crystal_apple.webp`,
    obtainableFromHatGame: false,
    repeatable: true,
    fusionEnabled: true,
  ...
  rare_star_berry: {
    ...
    type: STICKER_TYPES.RARE,
    rarity: STICKER_TYPES.RARE,
    image: `${STICKER_ASSET_BASE}/rare/star_berry.webp`,
    thumbnail: `${STICKER_ASSET_BASE}/rare/star_berry.webp`,
    obtainableFromHatGame: false,
    repeatable: true,
    fusionEnabled: true,
  ...
  rare_rainbow_cloud: {
    ...
    type: STICKER_TYPES.RARE,
    rarity: STICKER_TYPES.RARE,
    image: `${STICKER_ASSET_BASE}/rare/rainbow_cloud.webp`,
    thumbnail: `${STICKER_ASSET_BASE}/rare/rainbow_cloud.webp`,
    obtainableFromHatGame: false,
    repeatable: true,
    fusionEnabled: true,
  ...
  rare_dreamy_moon: {
    ...
    type: STICKER_TYPES.RARE,
    rarity: STICKER_TYPES.RARE,
    image: `${STICKER_ASSET_BASE}/rare/dreamy_moon.webp`,
    thumbnail: `${STICKER_ASSET_BASE}/rare/dreamy_moon.webp`,
    obtainableFromHatGame: false,
    repeatable: true,
    fusionEnabled: true,
  ...
  rare_golden_star: {
    ...
    type: STICKER_TYPES.RARE,
    rarity: STICKER_TYPES.RARE,
    image: `${STICKER_ASSET_BASE}/rare/golden_star.webp`,
    thumbnail: `${STICKER_ASSET_BASE}/rare/golden_star.webp`,
    obtainableFromHatGame: false,
    repeatable: true,
    fusionEnabled: true,
  ...
  rare_shining_rainbow: {
    ...
    type: STICKER_TYPES.RARE,
    rarity: STICKER_TYPES.RARE,
    image: `${STICKER_ASSET_BASE}/rare/shining_rainbow.webp`,
    thumbnail: `${STICKER_ASSET_BASE}/rare/shining_rainbow.webp`,
    obtainableFromHatGame: false,
    repeatable: true,
    fusionEnabled: true,
...
export const SPECIAL_STICKERS = Object.freeze({
  special_star_tree: {
    ...
    image: `${STICKER_ASSET_BASE}/special/star_tree.webp`,
    thumbnail: `${STICKER_ASSET_BASE}/special/star_tree.webp`,
    obtainableFromHatGame: false,
    repeatable: true,
    fusionEnabled: false,
  ...
  special_acorn_guardian: {
    ...
    type: STICKER_TYPES.SPECIAL,
    rarity: STICKER_TYPES.SPECIAL,
    image: `${STICKER_ASSET_BASE}/special/acorn_guardian.webp`,
    thumbnail: `${STICKER_ASSET_BASE}/special/acorn_guardian.webp`,
    obtainableFromHatGame: false,
    repeatable: true,
    fusionEnabled: false,
  ...
  special_magic_forest: {
    ...
    type: STICKER_TYPES.SPECIAL,
    rarity: STICKER_TYPES.SPECIAL,
    image: `${STICKER_ASSET_BASE}/special/magic_forest.webp`,
    thumbnail: `${STICKER_ASSET_BASE}/special/magic_forest.webp`,
    obtainableFromHatGame: false,
    repeatable: true,
    fusionEnabled: false,
  ...
  special_flower_garden: {
    ...
    type: STICKER_TYPES.SPECIAL,
    rarity: STICKER_TYPES.SPECIAL,
    image: `${STICKER_ASSET_BASE}/special/flower_garden.webp`,
    thumbnail: `${STICKER_ASSET_BASE}/special/flower_garden.webp`,
    obtainableFromHatGame: false,
    repeatable: true,
    fusionEnabled: false,
  ...
  special_butterfly_dream: {
    ...
    type: STICKER_TYPES.SPECIAL,
    rarity: STICKER_TYPES.SPECIAL,
    image: `${STICKER_ASSET_BASE}/special/butterfly_dream.webp`,
    thumbnail: `${STICKER_ASSET_BASE}/special/butterfly_dream.webp`,
    obtainableFromHatGame: false,
    repeatable: true,
    fusionEnabled: false,
  ...
  special_honey_castle: {
    ...
    type: STICKER_TYPES.SPECIAL,
    rarity: STICKER_TYPES.SPECIAL,
    image: `${STICKER_ASSET_BASE}/special/honey_castle.webp`,
    thumbnail: `${STICKER_ASSET_BASE}/special/honey_castle.webp`,
    obtainableFromHatGame: false,
    repeatable: true,
    fusionEnabled: false,
  ...
  special_crystal_tree: {
    ...
    type: STICKER_TYPES.SPECIAL,
    rarity: STICKER_TYPES.SPECIAL,
    image: `${STICKER_ASSET_BASE}/special/crystal_tree.webp`,
    thumbnail: `${STICKER_ASSET_BASE}/special/crystal_tree.webp`,
    obtainableFromHatGame: false,
    repeatable: true,
    fusionEnabled: false,
  ...
  special_star_picnic: {
    ...
    type: STICKER_TYPES.SPECIAL,
    rarity: STICKER_TYPES.SPECIAL,
    image: `${STICKER_ASSET_BASE}/special/star_picnic.webp`,
    thumbnail: `${STICKER_ASSET_BASE}/special/star_picnic.webp`,
    obtainableFromHatGame: false,
    repeatable: true,
    fusionEnabled: false,
  ...
  special_sky_castle: {
    ...
    type: STICKER_TYPES.SPECIAL,
    rarity: STICKER_TYPES.SPECIAL,
    image: `${STICKER_ASSET_BASE}/special/sky_castle.webp`,
    thumbnail: `${STICKER_ASSET_BASE}/special/sky_castle.webp`,
    obtainableFromHatGame: false,
    repeatable: true,
    fusionEnabled: false,
  ...
  special_moonlight_forest: {
    ...
    type: STICKER_TYPES.SPECIAL,
    rarity: STICKER_TYPES.SPECIAL,
    image: `${STICKER_ASSET_BASE}/special/moonlight_forest.webp`,
    thumbnail: `${STICKER_ASSET_BASE}/special/moonlight_forest.webp`,
    obtainableFromHatGame: false,
    repeatable: true,
    fusionEnabled: false,
  ...
  special_starry_sky: {
    ...
    type: STICKER_TYPES.SPECIAL,
    rarity: STICKER_TYPES.SPECIAL,
    image: `${STICKER_ASSET_BASE}/special/starry_sky.webp`,
    thumbnail: `${STICKER_ASSET_BASE}/special/starry_sky.webp`,
    obtainableFromHatGame: false,
    repeatable: true,
    fusionEnabled: false,
  ...
  special_rainbow_forest: {
    ...
    type: STICKER_TYPES.SPECIAL,
    rarity: STICKER_TYPES.SPECIAL,
    image: `${STICKER_ASSET_BASE}/special/rainbow_forest.webp`,
    thumbnail: `${STICKER_ASSET_BASE}/special/rainbow_forest.webp`,
    obtainableFromHatGame: false,
    repeatable: true,
    fusionEnabled: false,
 ...
 *
 * 素材命名建議：
 * public/stickers/achievement/{achievementId}_{stage}.webp
 *
 * 例如：
 * public/stickers/achievement/star_collector_seed.webp
 * public/stickers/achievement/star_collector_sprout.webp
 * public/stickers/achievement/star_collector_flower.webp
 * public/stickers/achievement/star_collector_fruit.webp
 * public/stickers/achievement/star_collector_starlight.webp
 */
export function createAchievementSticker({
  ...
  return Object.freeze({
    ...
    image:
      image ||
      `${STICKER_ASSET_BASE}/achievement/${safeAchievementId}_${safeStage}.webp`,
    thumbnail:
      image ||
      `${STICKER_ASSET_BASE}/achievement/${safeAchievementId}_${safeStage}.webp`,
    obtainableFromHatGame: false,
